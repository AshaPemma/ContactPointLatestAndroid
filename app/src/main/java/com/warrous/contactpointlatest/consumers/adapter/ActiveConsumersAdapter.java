...
public class ActiveConsumersAdapter extends RecyclerView.Adapter<
        ActiveConsumersAdapter.ImageVH> {
    ...
    public ActiveConsumersAdapter(ConsumersActivity activity,ImageVH.ClickListener clickListener) {
...
//    }
    ...
    public ImageVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.adapter_active_consumers, null);
