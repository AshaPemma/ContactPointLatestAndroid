...
import com.warrous.contactpointlatest.onBoarding.lib.listeners.AnimatorEndListener;
import com.warrous.contactpointlatest.onBoarding.lib.listeners.OnSwipeListener;
...
import com.warrous.contactpointlatest.onBoarding.lib.utils.PaperOnboardingEngineDefaults;
...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
    ...
    protected ViewGroup createContentTextView(PaperOnboardingPage PaperOnboardingPage) {
        LayoutInflater vi = LayoutInflater.from(mAppContext);
        final ViewGroup contentTextView = (ViewGroup) vi.inflate(R.layout.onboarding_text_content_layout, mContentTextContainer, false);
