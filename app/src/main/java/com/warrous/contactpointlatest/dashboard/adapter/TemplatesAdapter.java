...
import com.warrous.contactpointlatest.dashboard.NewEmailActivity;

public class TemplatesAdapter extends RecyclerView.Adapter<
        TemplatesAdapter.ImageVH>{

    private ImageVH.ClickListener clickListener;
    NewEmailActivity newEmailActivity;


    public TemplatesAdapter(NewEmailActivity activity,ImageVH.ClickListener clickListener) {
        // this.mShareImages = mShareImages;
        this.clickListener = clickListener;
        this.newEmailActivity = activity;
    }
...
//    }
    ...
    public ImageVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.adapter_templates, null);
